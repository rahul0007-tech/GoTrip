...
# class VehicleImages:
#     vehicle = models.ForeignKey(Driver, on_delete=models.CASCADE, related_name='vehicle')
#     images = models.ImageField(upload_to='vehicle_images',null=True, blank=True)
#     created_at = models.DateTimeField(auto_now_add=True)
#     updated_at = models.DateTimeField(auto_now_add=True)

#     def __str__(self):
#         return f"Images for {self.vehicle}"
